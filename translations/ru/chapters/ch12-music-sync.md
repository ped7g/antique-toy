...
![Демоплан n1k-o для Unspoken --- карта синхронизации с цветовым кодированием, экспортированная из Vortex Tracker в Excel. Каждая строка --- один кадр, цветные столбцы обозначают музыкальные слои: ударные (тёмно-синий), хеты (золотой), мелодия (зелёный), бас (фиолетовый). Это тот же рабочий процесс, изобретённый для GABBA и использованный для всех последующих демо команды.](illustrations/output/ch12_demoplan.png)
