...
![LZ-стиснення: потік байтів із літералами та зворотними посиланнями. Послідовності, що повторюються, замінюються токенами (зміщення, довжина), скорочуючи потік із 16 байтів до 10 токенів.](../../illustrations/output/ch14_lz_algorithm.png)
