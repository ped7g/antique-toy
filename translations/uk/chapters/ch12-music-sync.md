...
![Демоплан n1k-o для Unspoken -- карта синхронізації з кольоровим кодуванням, експортована з Vortex Tracker в Excel. Кожний рядок — один кадр, кольорові стовпці позначають музичні шари: ударні (темно-синій), хети (золотий), мелодія (зелений), бас (фіолетовий). Це той самий робочий процес, започаткований для GABBA та використаний для всіх наступних демо команди.](illustrations/output/ch12_demoplan.png)
