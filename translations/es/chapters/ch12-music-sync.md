...
![Demoplan de n1k-o para Unspoken -- mapa de sincronización codificado por colores exportado de Vortex Tracker a Excel. Cada fila es un fotograma, las columnas coloreadas marcan las capas musicales: percusión (azul marino), hi-hats (dorado), melodía (verde), bajo (morado). Este es el mismo flujo de trabajo pionero de GABBA, usado para todas las demos posteriores del equipo.](illustrations/output/ch12_demoplan.png)
